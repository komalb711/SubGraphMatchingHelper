...
public class NaiveMatching_non_induced {
    ...
    public static void main(String[] args) {
        NaiveMatching_non_induced obj = new NaiveMatching_non_induced();
    ...
    private void search(HashMap<Integer, Integer> embedding){
        ...
        if(embedding.size() == variableLabelMap.size()){
            ...
            for(int dataNodeId: candidateMap.get(queryNodeId)){
                ...
                if(edgeCheckingNonInduced(embedding, queryNodeId, dataNodeId)) {
